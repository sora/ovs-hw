...
/* Module Version: 5.4 */
/* /usr/local/diamond/1.4/ispfpga/bin/lin/scuba -w -lang verilog -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 256 -width 9 -depth 256 -rdata_width 9 -no_enable -pe -1 -pf -1 -e  */
/* Sun Oct 14 22:04:50 2012 */


`timescale 1 ns / 1 ps
module asfifo9 (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    Empty, Full);
    input wire [8:0] Data;
    input wire WrClock;
    input wire RdClock;
